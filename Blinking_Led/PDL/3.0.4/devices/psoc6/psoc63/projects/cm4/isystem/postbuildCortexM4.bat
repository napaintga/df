...
%EXEDIR%\winideaBuild.exe %IRFDIR%\..\..\cm0plus\isystem\psoc63_cm0plus_template.xqrf %TARGETNAME% /rebuild
IF %errorlevel% NEQ 0 EXIT /b %errorlevel%
ECHO.
ECHO Merging CM0p program with CM4 program into complete memory image
%IRFDIR%\..\..\..\..\..\..\tools\win\elf\cymcuelftool.exe --merge %OUTPUTPATH% %IRFDIR%\..\..\cm0plus\isystem\%MODE%\psoc63_cm0plus_template.elf --output %OUTPUTPATH%
IF %errorlevel% NEQ 0 EXIT /b %errorlevel%
GOTO generate_srec
